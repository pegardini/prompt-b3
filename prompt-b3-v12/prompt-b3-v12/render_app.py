...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .section p { color: #333; line-height: 1.6; margin-bottom: 10px; }
        .button-container { display: flex; gap: 15px; margin: 30px 0; flex-wrap: wrap; }
        .btn { padding: 15px 30px; border: none; border-radius: 8px; font-size: 1em; cursor: pointer; font-weight: bold; transition: all 0.3s ease; text-decoration: none; display: inline-block; text-align: center; }
        .btn-primary { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; }
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 10px 20px rgba(102, 126, 234, 0.3); }
        .btn-secondary { background: #f0f0f0; color: #333; border: 2px solid #667eea; }
        .btn-secondary:hover { background: #667eea; color: white; }
        .info-box { background: #e3f2fd; border-left: 4px solid #667eea; padding: 15px; border-radius: 4px; margin: 15px 0; color: #1565c0; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="section">
                <h2>🎯 Bem-vindo!</h2>
                <p>Este é o painel de administração do Prompt Fundamentalista B3.</p>
            </div>
            
            <div class="button-container">
                <a href="/admin" class="btn btn-primary">🔐 Painel Admin</a>
                <a href="/validar" class="btn btn-secondary">✅ Validar Chave</a>
            </div>
            
            <div class="info-box">
                <strong>💡 Dica:</strong> Use o painel admin para gerenciar clientes e chaves.
            </div>
        </div>
